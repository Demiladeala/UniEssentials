    ...
    <div className="flex flex-col-reverse">
          ...
          {product.images.map((image, index) => (
            ...
            >
              ...
              {index === selectedImage && (<span
                  className="pointer-events-none absolute inset-0 rounded-md ring-4 ring-gray-800 ring-offset-2"
                  aria-hidden="true"
                />)
              }
            </div>
      ...
      <div className="aspect-h-1 aspect-w-1 w-full">
        <Image
          ...
          className="h-full w-full max-lg:mt-[1rem] max-lg:w-[95%] mx-auto border-2 border-gray-200 object-cover object-center shadow-sm dark:border-gray-800 sm:rounded-lg"
        />
      </div>
    </div>
  )
